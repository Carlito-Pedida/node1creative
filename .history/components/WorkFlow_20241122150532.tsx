...
const AceternityIcon = ({ order }: { order: string }) => {
  return (
    <div>
      <button className="relative inline-flex overflow-hidden rounded-xxl p-[1px] ">
        <span
        ...
        justify-center rounded-xxl bg-slate-950 px-5 py-1 text-purple backdrop-blur-3xl font-bold text-2xl"
        >
          {order}
        </span>
      </button>
