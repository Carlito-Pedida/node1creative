        ...
        >
              ...
              <div className="flex flex-col gap-3 lg:gap-8">
                {leftStack.map((item, i) => (
                  <span
                    key={i}
                    className={`${
                      i !== 1 ? "text-purple" : "text-base"
                    }  lg:py-4 lg:px-3 py-2 px-3 text-xs lg:text-base opacity-50 
          ...
          {id === 6 && (
            <div className="mt-5 relative">
              ...
              <MagicButton
                buttonName={copied ? "Email copied!" : "Copy my email"}
                icon={<IoCopyOutline />}
                position="left"
